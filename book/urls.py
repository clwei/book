...
urlpatterns = [
    ...
    url(r'^book/checkout$', views.book_checkout), 
    url(r'^book/checkout/(?P<reader_id>\d+)/$', views.book_checkout), 
    url(r'^book/checkout/(?P<reader_id>\d+)/(?P<book_id>\d+)/$', views.book_checkout),
    url(r'^book/return/$', views.book_return),
    url(r'^book/return/(?P<book_id>\d+)/$', views.book_return),
    ...
    url(r'^circulation/combo$', views.circulation_combo),
]
